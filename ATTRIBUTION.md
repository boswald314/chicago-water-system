---
title: Image rights & attribution
---
...
- **Public-domain material** — Library of Congress HABS/HAER documentation, pre-1930 publications,
  Detroit Publishing Co. photographs, scans from Internet Archive/HathiTrust, and other PD items.
- **Creative Commons material** — reproduced under the license noted per image (CC0, CC BY, CC BY-SA,
  CC BY-NC), with source links.
- **Government/agency material** — photographs published by the Metropolitan Water Reclamation
  District of Greater Chicago (MWRD), USACE, USGS, and the City of Chicago, reproduced for
  research and education with attribution.
- **Rights-undetermined archival material** — items from the Chicago Public Library digital
  collections, Illinois Digital Archives, and local-history sources marked "rights undetermined"
